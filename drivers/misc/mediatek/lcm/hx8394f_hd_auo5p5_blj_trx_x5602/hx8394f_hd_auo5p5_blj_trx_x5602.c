...
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	// Set Power 
	{0xB1, 10, {0x50,0x0a,0x6a,0x09,0x33,0x54,0x71,0x71,0x4E,0x43}},
	// Set Display 
	{0xB2, 6, {0x65,0x80,0x64,0x05,0x07,0x2F}},
	// Set CYC 
	{0xB4, 21, {0x01,0x65,0x01,0x65,0x01,0x65,0x01,0x05,0x7E,0x35,
				0x00,0x3F,0x01,0x65,0x01,0x65,0x01,0x65,0x01,0x05,
				0x7E}},
	// Set VCOM
	{0xB6, 2, {0x53,0x53}},
	// Set D3
	{0xD3, 33, {0x00,0x00,0x0F,0x0F,0x01,0x01,0x10,0x10,0x32,0x10,
				...
				0x14,0x05,0x14,0x37,0x33,0x00,0x00,0x37,0x00,0x00,
				0x37,0x05,0x40}},
	// Set GIP 
	{0xD5, 44, {0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,
				...
				0x53,0x52,0x51,0x50,0x55,0x54,0x21,0x20,0x23,0x22,
				0x18,0x18,0x18,0x18}},
	// Set D6 
	{0xD6, 44, {0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,
				...
				0x14,0x15,0x16,0x17,0x12,0x13,0x26,0x27,0x24,0x25,
				0x18,0x18,0x18,0x18}},
	// Set Gamma 
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	//	params->dsi.intermediat_buffer_num = 0;//because DSI/DPI HW design change, this parameters should be 0 when video mode in MT658X; or memory leakage
			...
			params->dsi.horizontal_backporch = 80;//30
			params->dsi.horizontal_frontporch = 66; //30
...
LCM_DRIVER hx8394f_hd_auo5p5_blj_trx_x5602_lcm_drv = 
{
    .name			= "hx8394f_hd_auo5p5_blj_trx_x5602",
