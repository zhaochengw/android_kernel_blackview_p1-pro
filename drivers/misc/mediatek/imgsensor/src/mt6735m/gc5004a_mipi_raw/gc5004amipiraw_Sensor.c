...
#include "gc5004amipiraw_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "GC5004A_camera_sensor"
...
#define GC5004AMIPI_DRIVER_TRACE
#define SENSORDB(x,...)
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC5004AMIPI_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
{
		kal_uint32 idTem = ((read_cmos_sensor(0xf0) << 8) | read_cmos_sensor(0xf1));
		if(idTem ==GC5004MIPI_SENSOR_ID)
			{
				idTem = GC5004AMIPI_SENSOR_ID;
			}
    return idTem;
}
...
UINT32 GC5004AMIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
