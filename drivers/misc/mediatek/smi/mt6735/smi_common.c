...
#if defined(SMI_INTERNAL_CCF_SUPPORT)
static int get_smi_clk(struct clk ** smi_clk, char * smi_clk_name);
#endif
...
#if defined(SMI_INTERNAL_CCF_SUPPORT)
static int get_smi_clk(struct clk ** smi_clk_ptr, char * smi_clk_name){
...
#if defined(SMI_INTERNAL_CCF_SUPPORT)
    get_smi_clk(&(smi_dev->smi_common_clk), "smi-common");
    get_smi_clk(&(smi_dev->smi_larb0_clk), "smi-larb0");
    get_smi_clk(&(smi_dev->img_larb2_clk), "img-larb2");
    get_smi_clk(&(smi_dev->vdec0_vdec_clk), "vdec0-vdec");
    get_smi_clk(&(smi_dev->vdec1_larb_clk), "vdec1-larb");
    get_smi_clk(&(smi_dev->venc_larb_clk), "venc-larb");
#endif
